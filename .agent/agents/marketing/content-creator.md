...
## Submodule Context
**Current State**: Agent-facing chat service or wrapper. Uses streaming semantics and must respect meta-first and terminal done or error rules.

**Expected State**: Stable streaming behavior, safe request limits, and strict allowlists. Clean integration with gateway and audit pipelines.

**Behavior**: Provides chat agent capabilities, message routing, conversation management, and streaming responses for UI and API consumers.
